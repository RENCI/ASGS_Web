...
def find_stalled(cursor):
    try:
        ...
        for id in result:
            ...
            # if it is more than 6 hours, mark it as 'stalled'
            ...
            if ((current_time_utc - event_ts_naive) > expiration): 
                ...
                logging.info("find_stalled: updating state to stalled for instance:" + str(id[0]) + " and event grp:" + str(event_grp_id[0]))
