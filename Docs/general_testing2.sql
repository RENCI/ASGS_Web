...
INSERT INTO ASGS_Mon_event_group (instance_id, state_type_id, event_group_ts, storm_name, storm_number, advisory_id, final_product) VALUES ((select max(id) from ASGS_Mon_instance where site_id=0 and process_id=1), 1, datetime(), 'Alpha', '1', '1', 'product 1');
...
INSERT INTO ASGS_Mon_event (site_id, event_group_id, event_type_id, event_ts, advisory_id, pct_complete, process, raw_data) VALUES (0, (SELECT MAX(id) FROM ASGS_Mon_event_group where instance_id = (select max(id) from ASGS_Mon_instance where site_id=0 and process_id=1)), 1, datetime(), 'advisory 1', 10, 'instance 1', 'event data 1-1');;
INSERT INTO ASGS_Mon_event (site_id, event_group_id, event_type_id, event_ts, advisory_id, pct_complete, process, raw_data) VALUES (0, (SELECT MAX(id) FROM ASGS_Mon_event_group where instance_id = (select max(id) from ASGS_Mon_instance where site_id=0 and process_id=1)), 1, datetime(), 'advisory 1', 20, 'instance 1', 'event data 1-2');;
...
-- insert the actual events
INSERT INTO ASGS_Mon_event (site_id, event_group_id, event_type_id, event_ts, advisory_id, pct_complete, process, raw_data) VALUES (0, (SELECT MAX(id) FROM ASGS_Mon_event_group where instance_id = (select max(id) from ASGS_Mon_instance where site_id=0 and process_id=6)), 1, datetime(), 'advisory 1', 10, 'process 6', 'event data 6-1');;
INSERT INTO ASGS_Mon_event (site_id, event_group_id, event_type_id, event_ts, advisory_id, pct_complete, process, raw_data) VALUES (0, (SELECT MAX(id) FROM ASGS_Mon_event_group where instance_id = (select max(id) from ASGS_Mon_instance where site_id=0 and process_id=6)), 1, datetime(), 'advisory 1', 20, 'process 6', 'event data 6-2');;

INSERT INTO ASGS_Mon_event (site_id, event_group_id, event_type_id, event_ts, advisory_id, pct_complete, process, raw_data) VALUES (0, (SELECT MAX(id) FROM ASGS_Mon_event_group where instance_id = (select max(id) from ASGS_Mon_instance where site_id=0 and process_id=6)), 2, datetime(), 'advisory 1', 30, 'process 6', 'event data 6-3');;
INSERT INTO ASGS_Mon_event (site_id, event_group_id, event_type_id, event_ts, advisory_id, pct_complete, process, raw_data) VALUES (0, (SELECT MAX(id) FROM ASGS_Mon_event_group where instance_id = (select max(id) from ASGS_Mon_instance where site_id=0 and process_id=6)), 2, datetime(), 'advisory 1', 40, 'process 6', 'event data 6-4');;
...
-- insert an event group
INSERT INTO ASGS_Mon_event_group (instance_id, state_type_id, event_group_ts, storm_name, storm_number, advisory_id, final_product) VALUES ((select max(id) from ASGS_Mon_instance where site_id=1 and process_id=2), 1, datetime(), 'Beta', '2', '2', 'product 2');
...
-- insert the actual events
INSERT INTO ASGS_Mon_event (site_id, event_group_id, event_type_id, event_ts, advisory_id, pct_complete, process, raw_data) VALUES (0, (SELECT MAX(id) FROM ASGS_Mon_event_group where instance_id = (select max(id) from ASGS_Mon_instance where site_id=1 and process_id=2)), 1, datetime(), 'advisory 2', 10, 'process 2', 'event data 2-1');;
INSERT INTO ASGS_Mon_event (site_id, event_group_id, event_type_id, event_ts, advisory_id, pct_complete, process, raw_data) VALUES (0, (SELECT MAX(id) FROM ASGS_Mon_event_group where instance_id = (select max(id) from ASGS_Mon_instance where site_id=1 and process_id=2)), 1, datetime(), 'advisory 2', 20, 'process 2', 'event data 2-2');;

INSERT INTO ASGS_Mon_event (site_id, event_group_id, event_type_id, event_ts, advisory_id, pct_complete, process, raw_data) VALUES (0, (SELECT MAX(id) FROM ASGS_Mon_event_group where instance_id = (select max(id) from ASGS_Mon_instance where site_id=1 and process_id=2)), 2, datetime(), 'advisory 2', 30, 'process 2', 'event data 2-3');;
INSERT INTO ASGS_Mon_event (site_id, event_group_id, event_type_id, event_ts, advisory_id, pct_complete, process, raw_data) VALUES (0, (SELECT MAX(id) FROM ASGS_Mon_event_group where instance_id = (select max(id) from ASGS_Mon_instance where site_id=1 and process_id=2)), 2, datetime(), 'advisory 2', 40, 'process 2', 'event data 2-4');;
