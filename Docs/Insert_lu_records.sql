INSERT INTO ASGS_Mon_site_lu (id, name, description, cluster_name, nodes, tech_contact, location) VALUES (0, 'RENCI', '', 'Hatteras', 1024, '', 'NC');
...
INSERT INTO ASGS_Mon_message_type_lu (id, name, description) VALUES (2, 'Warning', '');
INSERT INTO ASGS_Mon_message_type_lu (id, name, description) VALUES (3, 'Error', '');
INSERT INTO ASGS_Mon_message_type_lu (id, name, description) VALUES (4, 'Fatal', '');

INSERT INTO ASGS_Mon_event_type_lu (id, name, description) VALUES (0, 'Weather | Hurricane', '');
