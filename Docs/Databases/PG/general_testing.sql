...
INSERT INTO "ASGS_Mon_event_group" (id, name, description, view_order, pct_complete) VALUES (0, 'RSTR', 'New run has started', 0, 0);
INSERT INTO "ASGS_Mon_event_group" (id, name, description, view_order, pct_complete) VALUES (1, 'PRE1', 'Pre-run 1 operations in progress', 1, 20);
INSERT INTO "ASGS_Mon_event_group" (id, name, description, view_order, pct_complete) VALUES (2, 'NOWC', 'NowCast operations in progress', 2, 40);
INSERT INTO "ASGS_Mon_event_group" (id, name, description, view_order, pct_complete) VALUES (3, 'PRE2', 'Pre-run 2 operations in progress', 3, 60);
INSERT INTO "ASGS_Mon_event_group" (id, name, description, view_order, pct_complete) VALUES (4, 'FDRC', 'Forcast operations in progress', 4, 80);
INSERT INTO "ASGS_Mon_event_group" (id, name, description, view_order, pct_complete) VALUES (5, 'POST', 'Post-run operations in progress', 5, 90);
INSERT INTO "ASGS_Mon_event_group" (id, name, description, view_order, pct_complete) VALUES (6, 'REND', 'Run has ended', 6, 100);
INSERT INTO "ASGS_Mon_event_group" (id, name, description, view_order, pct_complete) VALUES (7, 'RDY', 'Ready for next run', 6, 0);
...
(
        ...
        union
        select id, '2' as 'theorder', 'CONST_EVENT_TYPE_' ||  UPPER(REPLACE(name, ' ', '') || ' = ' || id) as 'const_name' from "ASGS_Mon_event_group"
        union
...
join "ASGS_Mon_event_group" etl on etl.id=e.event_type_id
...
--delete from "ASGS_Mon_event_group" where id=142; delete from "ASGS_Mon_event" where event_group_id=142;
